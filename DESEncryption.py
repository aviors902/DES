...
def main():
    ...
    print()
    print("Encrypting p' under k'")
    print("Using DES0 - Ciphertext c':", ciphertext40)
    print("Using DES1 - Ciphertext c':", ciphertext41)
    print("Using DES2 - Ciphertext c':", ciphertext42)
    print("Using DES3 - Ciphertext c':", ciphertext43)
    print()
    print("-------------------------------------")
    print()
    ...
    print()
    print("Encryption Process using DES0 ")
    ...
    print("**********************************")
    print()
    print("Encryption Process using DES1 ")
    print()
    print(" -Encrypting plaintext p under key k'          -Encrypting plaintext p' under k'")
    print("|-----------------------------------|        |-----------------------------------|")
    print("| ROUND | DES0 | DES1 | DES2 | DES3 |        | ROUND | DES0 | DES1 | DES2 | DES3 |")
    ...
    print("**********************************")
    print()
    print("Encryption Process using DES2 ")
    print()
    print(" -Encrypting plaintext p under key k          -Encrypting plaintext p' under k")
    print("|-----------------------------------|        |-----------------------------------|")
    print("| ROUND | DES0 | DES1 | DES2 | DES3 |        | ROUND | DES0 | DES1 | DES2 | DES3 |")
    ...
    print("**********************************")
    print()
    print("Encryption Process using DES3 ")
    print()
    print(" -Encrypting plaintext p under key k'          -Encrypting plaintext p' under k'")
    print("|-----------------------------------|        |-----------------------------------|")
    print("| ROUND | DES0 | DES1 | DES2 | DES3 |        | ROUND | DES0 | DES1 | DES2 | DES3 |")
